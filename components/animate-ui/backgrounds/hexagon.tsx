              ...
              (_, colIndex) => (
                <div
                  ...
                  className={cn(
                    ...
                    "before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-full dark:before:bg-neutral-950 before:bg-background before:opacity-100 before:transition-all before:duration-1000",
